...
void Orig()
{
    ...
    unsigned char uc; short unsigned us; unsigned ui; 
    unsigned long ul;
    ...
    ul = 0;
    ull = 0;
    printf("unsigned char uc; short unsigned us; unsigned ui; unsigned long ul; unsigned long long ull;\n\n"
	   "uc = %d us = %d  ui = %d  ul = %ld ull = %lld:->\n"
	   "uc = 0 us = 0  ui = 0 ul = 0 ull = 0\n\n",uc,us,ui,ul,ull);
