...
static void showcode(InsT_t * inst,int i)
{
  ...
  switch (inst->opcode) {
    ...
    case bgjob: sprintf(str, "bgjob    %d", inst->val.ival); break;
    ...
    case drefvolchar: s = "drefvolchar"; break;
    ...
    case refvolchar: s = "refvolchar"; break;
    case drefvoluchar: s = "drefvoluchar"; break;  
    ...
    case refvolshort: s = "refvolshort"; break;
    case drefvolshort: s = "drefvolshort"; break;
    ...
    case drefvolushort: s = "drefvolushort"; break;  
    ...
    case double2ullong: s = "double2ullong"; break;
    ...
    case drefvolint: s = "drefvolint   "; break;
    case refvolint: s = "refvolint   "; break;
    ...
    case int2long: s = "int2long"; break;
    case int2ullong: s = "int2ullong"; break;
    ...
    case drefvoluint: s = "drefvoluint   "; break;
    case refvoluint: s = "refvoluint   "; break;
    ...
    case uint2ullong: s = "uint2ullong"; break;
    ...
    case drefvollong: s = "drefvollong   "; break;
    case refvollong: s = "refvollong   "; break;
    ...
    case long2llong: s = "long2llong"; break;
    case long2ullong: s = "long2ullong"; break;
    ...
    case drefvolulong: s = "drefvolulong"; break;
    case refvolulong: s = "refvolulong"; break;
    ...
    case ulong2llong: s = "ulong2llong"; break;
    case ulong2ullong: s = "ulong2ullong"; break;
    ...
    case stollong: sprintf(str, "stollong   %d %d",
			  inst->val.ival,
			  inst->ext); break;
    case pushllong: sprintf(str, "pushllong  %lld", inst->val.llval); break;
    case rvalllong: sprintf(str, "rvalllong  %d %d",
			   inst->val.ival,
			   inst->ext); break;
    case drefllong: s = "drefllong   "; break;
    case refllong: s = "refllong   "; break;
    case drefvolllong: s = "drefvolllong   "; break;
    case refvolllong: s = "refvolllong   "; break;
    ...
    case llong2long: s = "llong2long"; break;
    case llong2double: s = "llong2double"; break;
      
    /* ullong something */
    case stoullong: sprintf(str, "stoullong   %d %d",
			  inst->val.ival,
			  inst->ext); break;
    case pushullong: sprintf(str, "pushullong  %llu", inst->val.ullval); break;
    case rvalullong: sprintf(str, "rvalullong  %d %d",
			   inst->val.ival,
			   inst->ext); break;
    case drefullong: s = "drefullong   "; break;
    case refullong: s = "refullong   "; break;
    case drefvolullong: s = "drefvolullong   "; break;
    case refvolullong: s = "refvolullong   "; break;
    case decullong: sprintf(str, "decullong   %d", inst->val.ival); break;
    case incullong: sprintf(str, "incullong   %d", inst->val.ival); break;
    case negullong: s = "negullong"; break;
    case ltullong: s = "ltullong"; break;
    case leullong: s = "leullong"; break;
    case equllong: s = "equllong"; break;
    case neullong: s = "neullong"; break;
    case gtullong: s = "gtullong"; break;
    case geullong: s = "geullong"; break;
    case lorullong: s = "lorullong"; break;
    case landullong: s = "landullong"; break;
    case notullong: s = "notullong"; break;
    case borullong: s = "borullong"; break;
    case xorullong: s = "xorullong"; break;
    case andullong: s = "andullong"; break;
    case addullong: s = "addullong"; break;
    case subullong: s = "subullong"; break;
    case divullong: s = "divullong"; break;
    case multullong: s = "multullong"; break;
    case modullong: s = "modullong"; break;
    case lshtullong: s = "lshtullong"; break;
    case rshtullong: s = "rshtullong"; break;
    case compullong: s = "compullong"; break;

    case ullong2ptr: s = "ullong2ptr"; break;
    case ullong2int: s = "ullong2int"; break;
    case ullong2long: s = "ullong2long"; break;
    case ullong2double: s = "ullong2double"; break;
