...
#define isvolatile(x)          ((x)->qual  & q_volatile)
#define isvolatilep(x)         ((x)->qual  & q_volatilep)
#define setVolatile(x)         ((x)->qual  |= q_volatile)
#define setVolatilep(x)     ((x)->qual  |= q_volatilep)
#define unsetVolatile(x)       ((x)->qual &= ~(q_volatile | q_volatilep))
